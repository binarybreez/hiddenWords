...
export function Header() {
  return (
    <div className="bg-white rounded-full w-[95%] md:w-2/3 shadow-md hover:shadow-primary hover:scale-103 transition-all flex items-center justify-between py-2 px-4 mx-auto">
